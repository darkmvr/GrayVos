...
anya_quotes = [
    # ... your original quotes here ...
]

anya_music_quotes = [
    # ... your original music quotes here ...
]
...
async def anya_voice(ctx, mode: str = None, *, query: str = None):
    ...
    if mode.lower() == "play":
        ...
        try:
            ...
            # fallback hardcoded YouTube URL
            url = "https://rr4---sn-5hne6nz6.googlevideo.com/videoplayback?expire=1767764587&ei=C55daZneDein6dsP-v7ewAk&ip=92.71.242.145&id=o-ACc8mWaRfwxzUNPu_MdroxAz6NV-wf4dOhu8v0DvY74r&itag=18&source=youtube&requiressl=yes"
            title = "Hardcoded fallback song"
